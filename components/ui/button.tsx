...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive active:scale-95 relative",
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground hover:shadow-lg hover:shadow-primary/30 dark:hover:shadow-primary/20',
        destructive:
          'bg-destructive text-white hover:shadow-lg hover:shadow-destructive/30 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40',
        outline:
          'border-2 border-primary text-primary hover:bg-primary/5 dark:border-primary/60 dark:text-primary/90 dark:hover:bg-primary/10',
        secondary:
